                            ...
                            <table class="table table-hover table-bordered table-striped" style="text-align: center;">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                         ...
                                         <td> <a href=view_teacher.php?> <button class=btn>Details</button></a> <a href=edit_teacher.php?> <button class=btn>Edit</button></a> <a href=delete_teacher.php?id=<?php echo $teacher['teacher_id']; ?>> <button class=btn>Delete</button></a></td>
                                         </tr>
                                    <?php
                                        }
                                        mysqli_close($con);
