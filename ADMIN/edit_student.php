...
<body>
    ...
    <?php
            ...
            $con= mysqli_connect(SERVER,DBUN,DBPW,DBNAME);
                ...
                if (isset($_POST['save'])) {
                    # code...#
                    $insert = "INSERT INTO `student`(`student_id`, `first_name`, `last_name`, `date_of_birth`, `gender`, `level`, `stream`, `email`, `contact`, `address`, `password`) VALUES ('".$_POST["stdid"]."','".$_POST["fname"]."','".$_POST["lname"]."','".$_POST["dob"]."','".$_POST["gender"]."','".$_POST["level"]."','".$_POST["stream"]."','".$_POST["email"]."','".$_POST["contact"]."','".$_POST["pswrd"]."')";
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-plus-square"></i> <a href="student_details.php">Student Details</a>
                            </li>
                            <li class="active">
                ...
                <div class="row">
                    ...
                    <div class="panel-body">
                        ...
                        <form role="form" method="post">
                            ...
                            <div class="form-group">
                                <label class="control-label" for="adrs">Password</label>
                                <input type="password" class="form-control" id="adrs" placeholder="Enter Password" name="pswrd" required="">
                            </div>
