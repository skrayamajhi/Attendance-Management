...
<?php
            ...
            $con= mysqli_connect(SERVER,DBUN,DBPW,DBNAME);
                ...
                if (isset($_POST['save'])) {
                    # code...#
                    $insert = "INSERT INTO `teacher`(`teacher_id`, `first_name`, `last_name`, `gender`, `password`, `contact`, `email`, `address`, `date_of_birth`, `course` ) VALUES ('".$_POST["tchid"]."','".$_POST["fname"]."','".$_POST["lname"]."','".$_POST["gndr"]."','".$_POST["pswrd"]."','".$_POST["cntct"]."','".$_POST["email"]."','".$_POST["adrs"]."','".$_POST["dob"]."')";
